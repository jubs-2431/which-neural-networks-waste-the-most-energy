...
random seeds, and exact PyTorch and torchvision versions are available in the
accompanying public repository. Reproducibility details are provided in
...
attribution are logged in the accompanying repository.
