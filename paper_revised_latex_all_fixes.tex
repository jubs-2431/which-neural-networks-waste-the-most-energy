...
Input and batch & $1 \times 3 \times 224 \times 224$, batch size 1 \\
Power command & \texttt{sudo powermetrics --samplers cpu\_power,gpu\_power,ane\_power -i 1000 -n 20 -f text -o <raw>} \\
...
\texttt{paper\_apple\_silicon\_benchmark.csv},
\texttt{measured\_architecture\_benchmark.csv},
\texttt{measured\_architecture\_trials.csv},
\texttt{measurement\_environment.json}, and
\texttt{MEASUREMENT\_PROTOCOL.md}. The release also includes the follow-up
direct energy audit under \texttt{measured\_energy\_powermetrics/}, including
\texttt{measured\_energy\_trials.csv},
\texttt{measured\_energy\_summary.csv},
\texttt{measurement\_environment\_energy.json}, and one raw
